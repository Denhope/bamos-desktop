...
// import StepForm from '@/components/woAdministration/StepForm';
// // Импортируйте другие формы по мере необходимости
...
//   // Если это окно формы, рендерим только форму
...
//         <div className="electron-form-window">
//           <FormComponent />
//         </div>
//       </ConfigProvider>
//     );
...
//   // Иначе рендерим основное приложение
//   return (
//     <div className="App">
//       <ConfigProvider locale={language === 'ru' ? ruRU : enUS}>
