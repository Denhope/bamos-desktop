...
const RequirementViewerModal: FC<RequirementViewerProps> = ({
  onDoubleClick,
  onSingleRowClick,
  onSelectedRowKeys,
  onSelectedRecords,
  ...
  return (
    <Layout>
      <Sider
        className="h-[66vh] overflow-hidden"
        theme="light"
        width={350}
        // collapsible
      ...
      <Content className="pl-4">
        <ProCard className="h-[66vh] overflow-hidden">
          <RequirementsList
            ...
            scroll={40}
            scrollX={2500}
            onSelectedIds={(data: any) => {
              setSelectedRowKeys(data);
              onSelectedRowKeys && onSelectedRowKeys(data);
            }}
            onSelectedParts={onSelectedRecords}
          />
        </ProCard>
      </Content>
    </Layout>
...
export default RequirementViewerModal;
