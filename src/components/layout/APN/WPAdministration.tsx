...
import WPPanel from '@/components/WPAdministration/WPPanel';
import WPFilterForm from '@/components/WPAdministration/WPFilterForm';

interface RequirementManagementProps {}

const WPAdministration: FC<RequirementManagementProps> = () => {
    ...
    <Layout>
      ...
      <Content className="pl-4">
        ...
        <div className="h-[82vh] overflow-hidden flex flex-col justify-between gap-5">
          <WPPanel projectSearchValues={requirementsSearch}></WPPanel>
        </div>
      </Content>
    </Layout>
  );
...
export default WPAdministration;
