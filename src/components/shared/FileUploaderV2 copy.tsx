      ...
      validationReportConfig.columns.forEach((column) => {
        switch (column.key) {
          ...
          case 'messages':
            ...
            break;
          default:
            // Для пользовательских полей берем значения из previewData
            reportRow[t(column.title)] = previewData[index]?.[column.key] || '';
        }
      });
                ...
                .map((column) => {
                  ...
                  switch (column.key) {
                    ...
                    case 'messages':
                      ...
                      break;
                    default:
                      cellContent = previewData[index]?.[column.key] || '';
                  }
        ...
        {instructions.tabs.map((tab: any) => (
          <Tabs.TabPane tab={t(tab.label)} key={tab.key}>
            {tab.content.type === 'table' ? (
              ...
              // Выносим текстовый контент за пределы таблицы
