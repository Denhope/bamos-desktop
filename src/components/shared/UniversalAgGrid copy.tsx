...
import { Button, Checkbox, Space, Input, Spin, Switch } from 'antd';
...
interface UniversalAgGridProps {
  ...
  onAddRow?: () => void;
  onCheckItems?: (selectedIds: string[]) => void; // Добавьте этот проп
  ...
  const handleRowSelection = useCallback(
    (event: SelectionChangedEvent) => {
      if (onRowSelect && gridApi) {
        ...
        console.log('Selected data in UniversalAgGrid:', selectedData);
    ...
    [onRowSelect, onCheckItems, gridApi]
  );
