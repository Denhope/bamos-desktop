...
const StockUnServise: FC = () => {
  const { t } = useTranslation();
  const { isLoading, filteredCurrentStockItems, filteredUnserviceDetails } =
  ...
  useEffect(() => {
    setData(filteredUnserviceDetails);
