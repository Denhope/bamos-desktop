...
const Instruments: FC = () => {
  ...
  const items: TabsProps["items"] = [
    {
      key: "1",
      label: `Инструмент всех работ`,
      children: (
        <InstrumentList
          data={allTasks}
          fileName={`Инструмент всех работ-${aplicationName}`}
        />
      ),
    },
    {
      key: "2",
      label: `Инструмент рутинных работ`,
      children: (
        <InstrumentList
          data={routineTasks}
          fileName={`Инструмент рутинных работ-${aplicationName}`}
        />
      ),
    },
    {
      key: "3",
      label: `Инструмент дополнительных работ и бюллетеней`,
      children: (
        <InstrumentList
          data={additionalTasks}
          fileName={`Инструмент дополнительных работ и бюллетеней-${aplicationName}`}
        />
      ),
    },
    {
      key: "4",
      label: `Инструмент работ Вне ВС`,
      children: (
        <InstrumentList
          data={hardTimeTasks}
          fileName={`Инструмент работ Вне ВС-${aplicationName}`}
        />
      ),
    },
  ];
