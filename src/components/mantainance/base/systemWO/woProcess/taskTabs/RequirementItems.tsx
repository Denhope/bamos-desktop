...
import { Cascader, ConfigProvider, Input, MenuProps, message } from "antd";
...
const RequirementItems: FC<RequirementItemsProps> = ({
  isLoading,
  scroll,
  projectTaskData,
  onReqClick,
  ...
  const initialColumns: ProColumns<any>[] = [
    ...
    // {
    //   title: `${t('BASE REQUIRED')}`,
    //   dataIndex: 'quantityOnTaskBase',
    //   key: 'quantityOnTaskBase',
    //   editable: (text, record, index) => {
    //     return false;
    //   },
            ...
            <div
              onClick={() =>
                ...
                exportToExcel(
                  ...
                  `Filtred-RequirementItems-${projectTaskData?.taskNumber}`
                )
              }
            >
            ...
            <div
              onClick={() =>
                ...
                exportToExcel(
                  ...
                  visibleColumns,
                  materialsRequirements,
                  `All RequirementItems-${projectTaskData?.taskNumber}`
                )
              }
            >
              <PrinterOutlined /> All Items
  ...
  return (
    <>
      {" "}
      <ModalForm
        title={`CREATE PICKSLIPS FOR W/O: ${projectTaskData?.projectTaskWO}`}
        // size={'large'}
        width={"80vw"}
        // placement={'bottom'}
        ...
        onFinish={async () => {
          ...
          message.success("PICKSLIP CREATED");
