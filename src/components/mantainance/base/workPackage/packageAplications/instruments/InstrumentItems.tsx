...
const InstrumentItems: FC<FilteredTasksListPropsType> = ({
  data,
  isLoading,
  scroll,
}) => {
    ...
    const fetchData = async () => {
      ...
      if (companyID) {
        ...
        if (result.meta.requestStatus === "fulfilled") {
          ...
          setInstrumentItems(result.payload.instruments);
        }
      }
    };
    fetchData();
            ...
            <div
              onClick={() =>
                ...
                exportToExcel(
                  ...
                  visibleColumns,
                  instrumentItems,
                  `Filtred-Instruments-${data.aplicationName}`
                )
              }
            >
            ...
            <div
              onClick={() =>
                ...
                exportToExcel(
                  ...
                  visibleColumns,
                  instrumentItems,
                  `All Instruments-${data.aplicationName}`
                )
              }
            >
              <PrinterOutlined /> All Items
