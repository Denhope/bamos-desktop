...
type RemoveItemFormProps = { currentItem: any };
const RemoveItemForm: FC<RemoveItemFormProps> = ({ currentItem }) => {
  ...
  return (
    <div>
      ...
      >
        ...
        <UserSearchProForm
          performedName={currentItem.removeMan ? currentItem.removeMan : null}
          performedSing={currentItem.removeSing ? currentItem.removeSing : null}
          onUserSelect={(user) => {
        ...
        <DateTimePickerForm
          ...
          dateTime={currentItem.removeDate ? currentItem.removeDate : null}
